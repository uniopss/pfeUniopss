...
/**
 * 	Récupération d'une section par son identifiant<br/>
 * 		Des paramètres attendus : <br>
 * 				- currentSection : l'indentifiant de la section dont on veut récupérer  <br/>
 *		Renvoi : <br/>
 *			- un vector contient un seul élément bean de type <code>Section</code><br/>
