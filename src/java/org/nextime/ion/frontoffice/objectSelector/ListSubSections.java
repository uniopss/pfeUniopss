...
/**
 * 	Renvoi une collection d'objets Section (online et offline )situées directement sous la Section
 * 	spécifiée par le parametre "rootSection"
 * 		Des paramètres attendus : <br>
 * 				- rootSection : l'indentifiant de la section dont on veut récupérer les publications online <br/>
 *		Renvoi : <br/>
 *			- un vector contient les élément bean de type <code>Section</code><br/>
