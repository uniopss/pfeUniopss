...
<body background="/backoffice/images/fond.gif" bgcolor="white" style="cursor:default" class="text"  onload="top.resizeTo(420,370)">
        <% if (request.getParameter("nom") != null && !"".equals(request.getParameter("nom")) && request.getParameter("valeur")!=null && !"".equals(request.getParameter("valeur"))) { %>
        ...
        <% } else { %>
                ...
                function searchLc(v) {
                        ...
                        else alert("Veuillez choisir un champ Produit");
                }
                </script>
                <form id="formu" name="formu" action="/backoffice/callout/<c:out value="${param['nom']}"/>.jsp" method="POST">
                <input type='hidden' id='zaction' name='zaction' value="<c:out value="${param['zaction']}"/>">
                ...
                <%
                        ...
                        for (int i=0; i<ps.size();i++) {
                                ...
                                if (name != null && !"".equals(name)) {
                                        ...
                                        if (!"t".equals(laction)) { %>
                        <tr>
                                <td valign="center" align='left' class='text' width='100' rowspan="2"><input type='hidden' name='<%=name%>' value='<%=j%>'><b>Produit<br>(<%=j%>): </b></td>
                                <td class=text>ID :&nbsp;<input onfocus="_focus=this" type='text' name='d_<%=name%>' value='<%=request.getParameter("d_"+name)!=null?request.getParameter("d_"+name):""%>' style="width:150px;">&nbsp;</td>
                                <td align="right">
                                <% if(i>0){%>
                ...
                <% if(ps.size()==0){%>
                        <tr>
                                <td width='160' align='right' class='text'><b>Ajouter un produit</b></td>
                ...
                <%}%>
                        <tr>
                                <td width='160' align='right' class='text'><b>Rechercher un produit </b></td>
                                <td valign='middle' align='center'><a href="#search" onclick="window.open('/backoffice/searchLc.x?popup=1','searchproduit','width=640,height=450,resizable=yes,scrollbars=yes');"><img style='border:0px;background-color:#F5F5F5' alt='Recherche Produit' src='/backoffice/images/pucef.gif' border='0'></a>
                                </td>
                        </tr>
                        <tr>
                                <td height="1" bgcolor="#949494"></td>
                        ...
                        <tr>
                                <td width='160' align='right' class='text'><b>Voir les liens circulaires </b></td>
                                <td valign='middle' align='center'><a href="#lien" onclick="window.open('/backoffice/callout/listProduitLien.jsp?zaction=<c:out value="${param['zaction']}"/>&plid=<c:out value="${param['plid']}"/>','lienproduit','width=400,height=300,resizable=yes,scrollbars=yes');"><img style='border:0px;background-color:#F5F5F5' alt='Liens circulaires' src='/backoffice/images/clef.gif' border='0'></a>
                                </td>
                        </tr>
                        <tr>
                                <td height="1" bgcolor="#949494"></td>
