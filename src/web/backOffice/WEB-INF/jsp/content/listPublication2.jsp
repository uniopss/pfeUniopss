...
function lcC(id) {
        window.opener.frm.<c:out value="${param['action']}"/>.value=id;
        self.close();
}
</script>
        <form name="lc" action="listPublication2.x" method="POST" onsubmit="if (!document.lc.keyWords.value) {alert('Veuillez saisir un mot clé avant de confirmer.');return false;}">
